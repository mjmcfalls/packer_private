...
build { 
  ...
  provisioner "powershell" {
    inline = [
      ...
      "${var.win_temp_dir}\\scripts\\atom\install_atom.ps1 -OutPath '${var.win_temp_dir}' -uri '${var.git_uri}' -install",
      "${var.win_temp_dir}\\scripts\\winmerge\install_winmerge.ps1 -OutPath '${var.win_temp_dir}' -uri '${var.git_uri}' -install",
