...
source "hyperv-iso" "autogenerated_1" {
  ...
  floppy_files     = ["${var.autounattend}","./src/scripts/ConfigureRemotingForAnsible.ps1", "./src/scripts/SetLocalAccountTokenFilterPolicy.ps1", "./src/scripts/setup_restart.bat", "./src/scripts/SetupComplete.cmd"]
...
build {
  ...
  provisioner "file" {
    source      = "./src/scripts/InstallApplication.ps1"
